...
module.exports = function () {
    ...
    var config = {
        ...
        webpackConfig: './config/webpack.prod.js',
        webpackConfigQa: './config/webpack.qa.js',        
        appEntryPoint: './src/main.js',

        general: {
            appName: "NETiD Client",
            rootFolder: "src/",
            indexHtml: "./src/index.html",
            roortFiles: ['./src/*.*', './ReleaseTemplate.md', '!'+'./src/*.ts']
        },
        // JavaScript settings
        js: {
            root: jsRoot,
        ...
        targets: {
            ...
            scriptsOutputPath: "./dist/scripts/",
